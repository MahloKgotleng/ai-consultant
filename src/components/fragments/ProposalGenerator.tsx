...
3 bullet points naming specific AI approaches (RAG, agentic workflow, predictive model, etc.) appropriate to their context. Reference IBM watsonx as the enterprise AI platform underpinning delivery.

## Kgotla AI's Approach
2-3 sentences on the 72-hour demo sprint methodology, IBM watsonx platform, IBM Partner Plus endorsement, B-BBEE Level 1 advantage.

## Proposed Next Steps
3 numbered steps: (1) scoping call, (2) 72-hour demo build on IBM watsonx, (3) pilot proposal.
    ...
    <div id="proposal-print" className="hidden print:block p-12 max-w-3xl mx-auto font-serif text-slate-900">
      ...
      <div className="flex items-center justify-between border-b-2 border-slate-900 pb-6 mb-8">
        <div>
          ...
          <div className="text-xs text-blue-600 font-semibold mt-1">Powered by IBM watsonx</div>
        </div>
      ...
      {/* Footer */}
      <div className="mt-12 pt-6 border-t border-slate-200 text-xs text-slate-400 flex justify-between items-end">
        <div>
          <div>mahlo@kgotlaai.co.za · 073 646 4935</div>
          <div>Reg. 2026/242882/07 · Evaton North, Gauteng</div>
        </div>
        <div className="text-right">
          <div className="text-blue-600 font-bold text-xs">Powered by IBM watsonx</div>
          <div>IBM Partner Plus Certified</div>
        </div>
      </div>
    </div>
  )
            ...
            <AnimatePresence mode="wait">
              ...
              {loading && (
                <motion.div key="loading" initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                  ...
                  <div className="text-slate-400 text-sm">IBM watsonx analysing {form.industry} sector benchmarks</div>
                </motion.div>
              )}
              {done && content && (
                <motion.div key="result" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
                  ...
                  <div className="pt-4 mt-4 border-t border-slate-700 space-y-3">
                    <div className="flex items-center justify-center gap-2 text-xs text-blue-400 font-semibold">
                      <span className="w-1.5 h-1.5 bg-blue-400 rounded-full animate-pulse" />
                      Generated by IBM watsonx · IBM Partner Plus Certified
                    </div>
